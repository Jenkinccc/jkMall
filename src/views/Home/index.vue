    ...
    <div class="banner">
      <el-carousel indicator-position="outside" height="480px">
        <el-carousel-item v-for="item in banner" :key="item.id">
          <img v-if="item.prcurl" class="img1" :src="item.picurl" alt="" />
          <img v-if="item.prcurl2" class="img2 a" :src="item.picurl2" alt="" />
          <img v-if="item.prcurl3" class="img3 b" :src="item.picurl3" alt="" />
        </el-carousel-item>
      </el-carousel>
    </div>
      ...
      <section class="w mt30 clearfix" v-if="item.type === 3">
        <m-shelf :title="item.name">
          <div slot="content" class="floors">
            <div
              class="imgbanner"
              v-if="(o, j) in item.panelContents"
              :key="j"
              v-if="o.type === 2 || o.type === 3"
            >
            <img src="o.picUrl" alt="">
            </div>
            <mall-goods :good='o' v-for='(o,i) in item.panelContents' :key='i' v-if='o.type===0'></mall-goods>
          </div>
        </m-shelf>
      </section>
    </div>
